...
27 tests couvrant la machine d'etats, le cycle enregistrement/transcription/collage, les preferences, le service Whisper et les mocks injectables.
...
- [x] Makefile avec cibles dev/test/app/install/clean
...
- [ ] Distribution via DMG signe ou Mac App Store
